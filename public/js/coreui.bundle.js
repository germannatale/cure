...
!(function (t, e) {
                        ...
                        ? (function (t, e, n) {
                              return function i(o) {
                                  for (var r = t.querySelectorAll(e), s = o.target; s && s !== this; s = s.parentNode)
                                      for (var a = r.length; a--; ) if (r[a] === s) return (o.delegateTarget = s), i.oneOff && Q.off(t, o.type, n), n.apply(s, [o]);
                                  return null;
                              };
                          })(t, n, i)
                        : (function (t, e) {
    ...
    var Q = {
            ...
            trigger: function (t, e, n) {
                ...
                var i,
                    ...
                    u = null;
                return (
                    r && D && ((i = D.Event(e, n)), D(t).trigger(i), (a = !i.isPropagationStopped()), (l = !i.isImmediatePropagationStopped()), (c = i.isDefaultPrevented())),
        ...
        Z = (function () {
            ...
            return (
                ...
                (n._loadPage = function (t) {
                    ...
                    var r = new CustomEvent("xhr", { detail: { url: t, status: o.status } });
                    n.dispatchEvent(r),
                        (o.onload = function (s) {
                            if (200 === o.status) {
                                (r = new CustomEvent("xhr", { detail: { url: t, status: o.status } })), n.dispatchEvent(r);
                                ...
                                a.querySelectorAll("script").forEach(function (t) {
                                    ...
                                    (n.innerHTML = ""),
                                    n.appendChild(a),
                                    (c = document.querySelectorAll(".view-script")).length &&
                ...
                (n._update = function (t) {
                    "#" !== t.href &&
                        (("undefined" != typeof t.dataset.toggle && "null" !== t.dataset.toggle) || ("_top" === t.target ? this._loadTop(t.href) : "_blank" === t.target ? this._loadBlank(t.href) : this._setUpUrl(t.getAttribute("href"))));
                }),
            ...
            return (
                (n.toggle = function () {
                    ...
                    if (n) {
                        ...
                        if (i && "radio" === i.type) {
                            if (i.checked && this._element.classList.contains(lt)) t = !1;
                            else {
            ...
            return (
                ...
                (n._addEventListeners = function () {
                    ...
                    this._config.keyboard &&
                        Q.on(this._element, "keydown.coreui.carousel", function (e) {
                            return t._keydown(e);
                        }),
                        "hover" === this._config.pause &&
                            (Q.on(this._element, "mouseenter.coreui.carousel", function (e) {
                                return t.pause(e);
                            }),
                ...
                (n._addTouchEventListeners = function () {
                    ...
                    st.find(".carousel-item img", this._element).forEach(function (t) {
                        ...
                        this._pointerEvent
                            ? (Q.on(this._element, "pointerdown.coreui.carousel", function (t) {
                                  return e(t);
                              }),
                            ...
                            : (Q.on(this._element, "touchstart.coreui.carousel", function (t) {
                                  return e(t);
                              }),
                ...
                (n._triggerSlideEvent = function (t, e) {
                    ...
                    return Q.trigger(this._element, "slide.coreui.carousel", { relatedTarget: t, direction: e, from: i, to: n });
                }),
                (n._setActiveIndicatorElement = function (t) {
                    if (this._indicatorsElement) {
                        for (var e = st.find(".active", this._indicatorsElement), n = 0; n < e.length; n++) e[n].classList.remove(Ct);
                ...
                (n._slide = function (t, e) {
                    ...
                    if ((t === Tt ? ((n = "carousel-item-left"), (i = "carousel-item-next"), (o = "left")) : ((n = "carousel-item-right"), (i = "carousel-item-prev"), (o = "right")), l && l.classList.contains(Ct))) this._isSliding = !1;
                        ...
                        if (((this._isSliding = !0), f && this.pause(), this._setActiveIndicatorElement(l), this._element.classList.contains("slide"))) {
                            ...
                            Q.one(s, c, function () {
                                l.classList.remove(n, i),
                                    ...
                                    (r._isSliding = !1),
                                    setTimeout(function () {
                                        Q.trigger(r._element, Ot, { relatedTarget: l, direction: o, from: a, to: u });
                                    }, 0);
                            }),
                                v(s, d);
                        } else s.classList.remove(Ct), l.classList.add(Ct), (this._isSliding = !1), Q.trigger(this._element, Ot, { relatedTarget: l, direction: o, from: a, to: u });
                        f && this.cycle();
                    }
                }),
    ...
    Q.on(document, "click.coreui.carousel.data-api", "[data-slide], [data-slide-to]", xt.dataApiClickHandler),
        Q.on(window, "load.coreui.carousel.data-api", function () {
            for (var t = st.find('[data-ride="carousel"]'), e = 0, n = t.length; e < n; e++) xt.carouselInterface(t[e], k(t[e], yt));
        });
    var Dt = E();
    if (Dt) {
        var jt = Dt.fn[bt];
                    ...
                    this._config.removeClass
                        ...
                        .forEach(function (n) {
                            t._config.responsive
                                ? t._updateResponsiveClassNames(n).forEach(function (n) {
    ...
    Q.on(document, "click.coreui.class-toggler.data-api", Wt, function (t) {
        ...
        e.classList.contains("c-class-toggler") || (e = e.closest(Wt)),
            "undefined" != typeof e.dataset.addClass && Yt.classTogglerInterface(e, "add"),
            "undefined" != typeof e.dataset.removeClass && Yt.classTogglerInterface(e, "remove"),
            "undefined" != typeof e.dataset.toggleClass && Yt.classTogglerInterface(e, "toggle"),
            "undefined" != typeof e.dataset.class && Yt.classTogglerInterface(e, "class");
    });
    var Xt = E();
    if (Xt) {
        var Bt = Xt.fn[Nt];
    ...
    var Ut = "collapse",
        ...
        Zt = (function () {
            ...
            return (
                (n.toggle = function () {
                    // Error al collapsar en accordion.
                ...
                (n.show = function () {
                    ...
                    if (!this._isTransitioning && !this._element.classList.contains(Vt)) {
                        ...
                        this._parent &&
                            0 ===
                                (n = st.find(".show, .collapsing", this._parent).filter(function (t) {
                ...
                (t.collapseInterface = function (e, n) {
                    var i = k(e, qt),
                        r = o(o(o({}, Qt), _t.getDataAttributes(e)), "object" == typeof n && n ? n : {});
                ...
                (("body" !== ae(e) || fe(o)) &&
                    (a =
                        (i = e) !== ie(i) && se(i)
                            ...
                            : oe(i)),
                se(e) ? (((l = ne(e)).x += e.clientLeft), (l.y += e.clientTop)) : o && (l.x = ce(o))),
    ...
    function _e(t) {
        for (var e = ie(t), n = ve(t); n && me(n) && "static" === ue(n).position; ) n = ve(n);
            ...
            ? Pe(
                  (function (t) {
                      var e = ie(t),
                          ...
                          s = 0,
                          a = 0;
                      return i && ((o = i.width), (r = i.height), /^((?!chrome|android).)*safari/i.test(navigator.userAgent) || ((s = i.offsetLeft), (a = i.offsetTop))), { width: o, height: r, x: s + ce(t), y: a };
                  })(t)
              )
            : se(e)
            ? (function (t) {
            ...
            : Pe(
                  (function (t) {
                      var e = le(t),
                          ...
                          s = -n.scrollLeft + ce(t),
                          a = -n.scrollTop;
                      return "rtl" === ue(i || e).direction && (s += Math.max(e.clientWidth, i ? i.clientWidth : 0) - o), { width: o, height: r, x: s, y: a };
                  })(le(t))
              );
    }
    function Me(t, e, n) {
    ...
    function Fe(t) {
        ...
        return function (t, e, n) {
            ...
            var o,
                s,
                a = { placement: "bottom", orderedModifiers: [], options: Object.assign(Object.assign({}, qe), r), modifiersData: {}, elements: { reference: t, popper: e }, attributes: {}, styles: {} },
                l = [],
                c = !1,
                u = {
                    state: a,
                    setOptions: function (n) {
                        f(), (a.options = Object.assign(Object.assign(Object.assign({}, r), a.options), n)), (a.scrollParents = { reference: re(t) ? ge(t) : t.contextElement ? ge(t.contextElement) : [], popper: ge(e) });
                        var o,
                            s,
                            c = (function (t) {
                                var e = je(t);
                    ...
                    forceUpdate: function () {
                        if (!c) {
                            var t = a.elements,
                                ...
                                n = t.popper;
                            if (Qe(e, n)) {
                                (a.rects = { reference: he(e, _e(n), "fixed" === a.options.strategy), popper: de(n) }),
                                    (a.reset = !1),
    ...
    function Ke(t) {
        ...
        return a
            ? Object.assign(
                  Object.assign({}, b),
                  {},
                  (((_ = {})[g] = d ? "0" : ""), (_[p] = h ? "0" : ""), (_.transform = (m.devicePixelRatio || 1) < 2 ? "translate(" + u + "px, " + f + "px)" : "translate3d(" + u + "px, " + f + "px, 0)"), _)
              )
            : Object.assign(Object.assign({}, b), {}, (((e = {})[g] = d ? f + "px" : ""), (e[p] = h ? u + "px" : ""), (e.transform = ""), e));
    }
    ...
    function tn(t, e) {
        ...
        var d = h.reduce(function (e, n) {
            return (e[n] = Ue(t, { placement: n, boundary: o, rootBoundary: r, padding: s })[Ne(n)]), e;
        }, {});
            ...
            defaultModifiers: [
                ...
                },
                {
                    ...
                    fn: function (t) {
                        var e = t.state,
                            n = t.name;
                        e.modifiersData[n] = Ye({ reference: e.rects.reference, element: e.rects.popper, strategy: "absolute", placement: e.placement });
                    },
                    data: {},
                },
                {
                    ...
                    fn: function (t) {
                        ...
                        null != e.modifiersData.popperOffsets &&
                            (e.styles.popper = Object.assign(Object.assign({}, e.styles.popper), Ke(Object.assign(Object.assign({}, a), {}, { offsets: e.modifiersData.popperOffsets, position: e.options.strategy, adaptive: s })))),
                            null != e.modifiersData.arrow &&
                                (e.styles.arrow = Object.assign(Object.assign({}, e.styles.arrow), Ke(Object.assign(Object.assign({}, a), {}, { offsets: e.modifiersData.arrow, position: "absolute", adaptive: !1 })))),
                                ...
                                return (
                                    (t[n] = (function (t, e, n) {
                                        var i = Ne(t),
                                            ...
                                            s = r[0],
                                            a = r[1];
                                        return (s = s || 0), (a = (a || 0) * o), [Ee, we].indexOf(i) >= 0 ? { x: a, y: s } : { x: s, y: a };
                                    })(n, e.rects, r)),
                                    t
                                );
                            }, {}),
                            ...
                            for (
                                var o = n.mainAxis,
                                    ...
                                    b = [m].concat(_).reduce(function (t, n) {
                                        return t.concat(Ne(n) === Le ? tn(e, { placement: n, boundary: u, rootBoundary: f, padding: c, flipVariations: p, allowedAutoPlacements: g }) : n);
                                    }, []),
                                    y = e.rects.reference,
                                    w = e.rects.popper,
                                    E = new Map(),
                ...
                },
                {
                    ...
                    effect: function (t) {
                        ...
                        null != r &&
                            ...
                            ((e.elements.arrow = r), (e.modifiersData[i + "#persistent"] = { padding: Xe("number" != typeof a ? a : Be(a, Te)) }));
                    },
                    requires: ["popperOffsets"],
        ...
        kn = (function () {
            ...
            return (
                    ...
                    if (!(this._element.disabled || this._element.classList.contains(_n) || this._menu.classList.contains(bn))) {
                        ...
                        if (!Q.trigger(e, "show.coreui.dropdown", n).defaultPrevented) {
                            if (!this._inNavbar && !this._inHeader) {
                                ...
                                var i = this._element;
                                "parent" === this._config.reference ? (i = e) : m(this._config.reference) && ((i = this._config.reference), "undefined" != typeof this._config.reference.jquery && (i = this._config.reference[0])),
                                    "scrollParent" !== this._config.boundary && e.classList.add("position-static"),
                                    (this._popper = rn(i, this._menu, this._getPopperConfig()));
                            }
                            var o, r;
                ...
                (n._getPlacement = function () {
                    ...
                    return (
                        t.classList.contains("dropup")
                            ? ((e = "top-start"), this._menu.classList.contains(yn) && (e = "top-end"))
                            : t.classList.contains("dropright")
                            ? (e = "right-start")
                            : t.classList.contains("dropleft")
                            ? (e = "left-start")
                            : this._menu.classList.contains(yn) && (e = "bottom-end"),
                        e
                    );
                }),
                ...
                (n._getPopperConfig = function () {
                    ...
                    return "static" === this._config.display && (t.modifiers = { name: "applyStyles", enabled: !1 }), o(o({}, t), this._config.popperConfig);
                }),
                ...
                (t.clearMenus = function (e) {
                    if (!e || (2 !== e.button && ("keyup" !== e.type || "Tab" === e.key)))
                        for (var n = st.find(wn), i = 0, o = n.length; i < o; i++) {
                            ...
                            if ((e && "click" === e.type && (a.clickEvent = e), s)) {
                                ...
                                if (r.classList.contains(bn))
                                    if (!(e && (("click" === e.type && /input|textarea/i.test(e.target.tagName)) || ("keyup" === e.type && "Tab" === e.key)) && r.contains(e.target)))
                                        if (!Q.trigger(r, pn, a).defaultPrevented) {
                                            var c;
                ...
                (t.dataApiKeydownHandler = function (e) {
                    if (
                        !(/input|textarea/i.test(e.target.tagName) ? e.key === un || (e.key !== cn && ((e.key !== hn && e.key !== fn) || e.target.closest(En))) : !dn.test(e.key)) &&
                        (e.preventDefault(), e.stopPropagation(), !this.disabled && !this.classList.contains(_n))
                    ) {
            ...
            return (
                ...
                (n.show = function (t) {
                    ...
                    if (!this._isShown && !this._isTransitioning) {
                        ...
                        var n = Q.trigger(this._element, Pn, { relatedTarget: t });
                        this._isShown ||
                            n.defaultPrevented ||
                            ((this._isShown = !0),
                            ...
                            Q.on(this._element, Hn, '[data-dismiss="modal"]', function (t) {
                                return e.hide(t);
                            }),
                ...
                (n._showElement = function (t) {
                    ...
                    var o = function () {
                        e._config.focus && e._element.focus(), (e._isTransitioning = !1), Q.trigger(e._element, "shown.coreui.modal", { relatedTarget: t });
                    };
                    if (n) {
                ...
                (t.jQueryInterface = function (e, n) {
                    return this.each(function () {
                        var i = k(this, An),
                            r = o(o(o({}, jn), _t.getDataAttributes(this)), "object" == typeof e && e ? e : {});
            ...
            return (
                ...
                (n.toggle = function (t) {
                    if (this._isEnabled)
                        if (t) {
                            ...
                            n || ((n = new this.constructor(t.delegateTarget, this._getDelegateConfig())), T(t.delegateTarget, e, n)),
                ...
                (n.dispose = function () {
                    clearTimeout(this._timeout),
                        ...
                        Q.off(this.element.closest(".modal"), "hide.coreui.modal", this._hideModalHandler),
                ...
                (n.show = function () {
                    ...
                    if (this.isWithContent() && this._isEnabled) {
                        ...
                        if (
                            ...
                            (this._popper = rn(this.element, o, this._getPopperConfig(l))),
                            o.classList.add(fi),
                ...
                (n.hide = function () {
                    ...
                    if (!Q.trigger(this.element, this.constructor.Event.HIDE).defaultPrevented) {
                        var i;
                        if ((e.classList.remove(fi), "ontouchstart" in document.documentElement))
                ...
                (n.setElementContent = function (t, e) {
                    if (null !== t)
                        return "object" == typeof e && m(e)
                            ...
                            : void (this.config.html ? (this.config.sanitize && (e = ti(e, this.config.whiteList, this.config.sanitizeFn)), (t.innerHTML = e)) : (t.textContent = e));
                }),
                (n.getTitle = function () {
                ...
                (n._setListeners = function () {
                    ...
                    this.config.trigger.split(" ").forEach(function (e) {
                        ...
                        Q.on(this.element.closest(".modal"), "hide.coreui.modal", this._hideModalHandler),
                ...
                (n._enter = function (t, e) {
                    ...
                    (e = e || k(t.delegateTarget, n)) || ((e = new this.constructor(t.delegateTarget, this._getDelegateConfig())), T(t.delegateTarget, n, e)),
                        t && (e._activeTrigger["focusin" === t.type ? gi : pi] = !0),
                        e.getTipElement().classList.contains(fi) || e._hoverState === hi
                            ? (e._hoverState = hi)
                ...
                (n._leave = function (t, e) {
                    var n = this.constructor.DATA_KEY;
                    (e = e || k(t.delegateTarget, n)) || ((e = new this.constructor(t.delegateTarget, this._getDelegateConfig())), T(t.delegateTarget, n, e)),
                        t && (e._activeTrigger["focusout" === t.type ? gi : pi] = !1),
                ...
                (n._getConfig = function (t) {
                    ...
                    return (
                        ...
                        "number" == typeof (t = o(o(o({}, this.constructor.Default), e), "object" == typeof t && t ? t : {})).delay && (t.delay = { show: t.delay, hide: t.delay }),
        ...
        Hi = (function () {
            function t(t, e) {
                ...
                (this._element = t),
                    ...
                    (this._config = this._getConfig(e)),
                    (this._selector = this._config.target + " " + ".nav-link, " + this._config.target + " " + ".list-group-item, " + this._config.target + " ." + Ii),
                    (this._offsets = []),
                    (this._targets = []),
                    (this._activeTarget = null),
                    (this._scrollHeight = 0),
                    Q.on(this._scrollElement, "scroll.coreui.scrollspy", function (t) {
                        return n._process(t);
                    }),
                    this.refresh(),
                    this._process(),
            ...
            return (
                ...
                (n._getConfig = function (t) {
                    if ("string" != typeof (t = o(o({}, ji), "object" == typeof t && t ? t : {})).target && m(t.target)) {
                        var e = t.target.id;
                ...
                (n._activate = function (t) {
                    ...
                    n.classList.contains(Ii)
                        ? (st.findOne(".dropdown-toggle", n.closest(".dropdown")).classList.add(Pi), n.classList.add(Pi))
                        : (n.classList.add(Pi),
                          st.parents(n, ".nav, .list-group").forEach(function (t) {
                        ...
                        Q.trigger(this._scrollElement, "activate.coreui.scrollspy", { relatedTarget: t });
                }),
                (n._clear = function () {
    ...
    function ro(t, e, n, i, o) {
        ...
        !(function (t, e, n, i, o) {
            ...
            e &&
                ...
                e < 0 ? f.dispatchEvent(oo("ps-scroll-" + c)) : e > 0 && f.dispatchEvent(oo("ps-scroll-" + u)),
                i &&
                    (function (t, e) {
                        Zi(t, e), to(t, e);
                    })(t, l));
        ...
        (t.containerWidth = Math.ceil(i.width)),
            ...
            !t.settings.suppressScrollX && t.containerWidth + t.settings.scrollXMarginOffset < t.contentWidth
                ? ((t.scrollbarXActive = !0),
                  ...
                  (t.scrollbarXWidth = co(t, so((t.railXWidth * t.containerWidth) / t.contentWidth))),
                  (t.scrollbarXLeft = so(((t.negativeScrollAdjustment + e.scrollLeft) * (t.railXWidth - t.scrollbarXWidth)) / (t.contentWidth - t.containerWidth))))
                : (t.scrollbarXActive = !1),
            !t.settings.suppressScrollY && t.containerHeight + t.settings.scrollYMarginOffset < t.contentHeight
                ? ((t.scrollbarYActive = !0),
                  (t.railYHeight = t.containerHeight - t.railYMarginHeight),
                  (t.railYRatio = t.containerHeight / t.railYHeight),
                  (t.scrollbarYHeight = co(t, so((t.railYHeight * t.containerHeight) / t.contentHeight))),
                  (t.scrollbarYTop = so((n * (t.railYHeight - t.scrollbarYHeight)) / (t.contentHeight - t.containerHeight))))
            ...
            (function (t, e) {
                ...
                Bi(e.scrollbarYRail, o), Bi(e.scrollbarX, { left: e.scrollbarXLeft, width: e.scrollbarXWidth - e.railBorderXWidth }), Bi(e.scrollbarY, { top: e.scrollbarYTop, height: e.scrollbarYHeight - e.railBorderYWidth });
            })(e, t),
            t.scrollbarXActive ? e.classList.add(Gi.active("x")) : (e.classList.remove(Gi.active("x")), (t.scrollbarXWidth = 0), (t.scrollbarXLeft = 0), (e.scrollLeft = !0 === t.isRtl ? t.contentWidth : 0)),
            t.scrollbarYActive ? e.classList.add(Gi.active("y")) : (e.classList.remove(Gi.active("y")), (t.scrollbarYHeight = 0), (t.scrollbarYTop = 0), (e.scrollTop = 0));
    }
    function co(t, e) {
    ...
    function uo(t, e) {
        ...
        function v(e, s) {
            (h = f[l]),
                ...
                (d = e[o]),
                (p = (t[i] - t[n]) / (t[r] - t[a])),
                s ? t.event.bind(t.ownerDocument, "touchmove", g) : (t.event.bind(t.ownerDocument, "mousemove", g), t.event.once(t.ownerDocument, "mouseup", m), e.preventDefault()),
    ...
    var fo = {
            ...
            "drag-thumb": function (t) {
                uo(t, ["containerWidth", "contentWidth", "pageX", "railXWidth", "scrollbarX", "scrollbarXWidth", "scrollLeft", "x", "scrollbarXRail"]),
                    uo(t, ["containerHeight", "contentHeight", "pageY", "railYHeight", "scrollbarY", "scrollbarYHeight", "scrollTop", "y", "scrollbarYRail"]);
            },
            keyboard: function (t) {
                var e = t.element;
            ...
            touch: function (t) {
                if (ao.supportsTouch || ao.supportsIePointer) {
                    var e = t.element,
                        ...
                        r = null;
                    ao.supportsTouch
                        ? (t.event.bind(e, "touchstart", c), t.event.bind(e, "touchmove", u), t.event.bind(e, "touchend", f))
                        : ao.supportsIePointer &&
                          (window.PointerEvent
                              ? (t.event.bind(e, "pointerdown", c), t.event.bind(e, "pointermove", u), t.event.bind(e, "pointerup", f))
                              : window.MSPointerEvent && (t.event.bind(e, "MSPointerDown", c), t.event.bind(e, "MSPointerMove", u), t.event.bind(e, "MSPointerUp", f)));
                }
                function s(n, i) {
                ...
                function f() {
                    t.settings.swipeEasing &&
                        ...
                        (r = setInterval(function () {
                            t.isInitialized ? clearInterval(r) : o.x || o.y ? (Math.abs(o.x) < 0.01 && Math.abs(o.y) < 0.01 ? clearInterval(r) : (s(30 * o.x, 30 * o.y), (o.x *= 0.8), (o.y *= 0.8))) : clearInterval(r);
                        }, 10)));
                }
            },
        },
        ho = function (t, e) {
            ...
            (this.scrollbarXBottom = parseInt(l.bottom, 10)),
                isNaN(this.scrollbarXBottom) ? ((this.isScrollbarXUsingBottom = !1), (this.scrollbarXTop = so(l.top))) : (this.isScrollbarXUsingBottom = !0),
                (this.railBorderXWidth = so(l.borderLeftWidth) + so(l.borderRightWidth)),
            ...
            (this.scrollbarYRight = parseInt(c.right, 10)),
                isNaN(this.scrollbarYRight) ? ((this.isScrollbarYUsingRight = !1), (this.scrollbarYLeft = so(c.left))) : (this.isScrollbarYUsingRight = !0),
                (this.scrollbarYOuterWidth = this.isRtl
                    ...
                    : null),
                (this.railBorderYWidth = so(c.borderTopWidth) + so(c.borderBottomWidth)),
    ...
    (ho.prototype.update = function () {
        this.isAlive &&
            ...
            Bi(this.scrollbarXRail, { display: "block" }),
            Bi(this.scrollbarYRail, { display: "block" }),
            (this.railXMarginWidth = so(Xi(this.scrollbarXRail).marginLeft) + so(Xi(this.scrollbarXRail).marginRight)),
            (this.railYMarginHeight = so(Xi(this.scrollbarYRail).marginTop) + so(Xi(this.scrollbarYRail).marginBottom)),
            ...
            return (
                (n.open = function (t) {
                    ...
                    Q.trigger(this._element, "open.coreui.sidebar"),
                        this._isMobile()
                            ...
                            : t
                            ? (this._addClassName(this._getBreakpointClassName(t)),
                              this._isOverlaid() &&
                                  Q.one(this._element, c, function () {
                                      e._addClickOutListener();
                                  }))
                ...
                (n.close = function (t) {
                    ...
                    Q.trigger(this._element, "close.coreui.sidebar"),
                        this._isMobile()
                            ? (this._element.classList.remove(this._firstBreakpointClassName()), this._removeBackdrop(), this._removeClickOutListener())
                            : t
                            ? (this._element.classList.remove(this._getBreakpointClassName(t)), this._isOverlaid() && this._removeClickOutListener())
                            : (this._element.classList.remove(this._firstBreakpointClassName()), this._isOverlaid() && this._removeClickOutListener());
                    var n = p(this._element);
                    Q.one(this._element, c, function () {
                ...
                (n.reset = function () {
                    this._element.classList.contains(wo) && (this._element.classList.remove(wo), (this._minimize = !1), Q.one(this._element, c, this._psInit())),
                        this._element.classList.contains(Eo) && (this._element.classList.remove(Eo), (this._unfoldable = !1));
                }),
                (n._getConfig = function (t) {
                ...
                (n._toggleDropdown = function (t, e) {
                    ...
                    "undefined" != typeof i.dropdownAccordion && (mo.dropdownAccordion = JSON.parse(i.dropdownAccordion)),
                ...
                (n._psInit = function () {
                    this._element.querySelector(Co) && !this._isIOS() && (this._ps = new ho(this._element.querySelector(Co), { suppressScrollX: !0, wheelPropagation: !1 }));
                }),
                ...
                (n._setActiveLink = function () {
                    ...
                    Array.from(this._element.querySelectorAll(Oo)).forEach(function (e) {
                        ...
                        "#" ===
                            (n =
                                /\\?.*=/.test(String(window.location)) || /\\?./.test(String(window.location))
                                    ? String(window.location).split("?")[0]
                                    : /#./.test(String(window.location))
                                    ? String(window.location).split("#")[0]
                                    : String(window.location)).slice(-1) && (n = n.slice(0, -1));
                        var i = e.closest(Co).dataset;
                        "undefined" != typeof i.activeLinksExact && (mo.activeLinksExact = JSON.parse(i.activeLinksExact)),
                            mo.activeLinksExact &&
                                e.href === n &&
                                (e.classList.add(_o),
                                Array.from(t._getParents(e, ko)).forEach(function (t) {
                                    t.classList.add(yo);
                                })),
                            !mo.activeLinksExact &&
                                e.href.startsWith(n) &&
                ...
                (n._addEventListeners = function () {
                    ...
                    this._mobile && this._open && this._addClickOutListener(),
                        ...
                        Q.on(this._element, "classtoggle", function (e) {
                            if (
                                (e.detail.className === wo && (t._element.classList.contains(wo) ? t.minimize() : t.reset()),
                                e.detail.className === Eo && (t._element.classList.contains(Eo) ? t.unfoldable() : t.reset()),
                                "undefined" !=
                                    typeof Object.keys(mo.breakpoints).find(function (t) {
            ...
            return (
                (n.show = function () {
                    ...
                    if (!((this._element.parentNode && this._element.parentNode.nodeType === Node.ELEMENT_NODE && this._element.classList.contains(No)) || this._element.classList.contains("disabled"))) {
                        ...
                        var r = null;
                        if ((e && (r = Q.trigger(e, "hide.coreui.tab", { relatedTarget: this._element })), !(Q.trigger(this._element, "show.coreui.tab", { relatedTarget: e }).defaultPrevented || (null !== r && r.defaultPrevented)))) {
                            this._activate(this._element, i);
                            var s = function () {
                                Q.trigger(e, "hidden.coreui.tab", { relatedTarget: t._element }), Q.trigger(t._element, "shown.coreui.tab", { relatedTarget: e });
                            };
                ...
                (n._transitionComplete = function (t, e, n) {
                    ...
                    (t.classList.add(No), "tab" === t.getAttribute("role") && t.setAttribute("aria-selected", !0), w(t), t.classList.contains(Io) && t.classList.add(Po), t.parentNode && t.parentNode.classList.contains("dropdown-menu")) &&
                        (t.closest(".dropdown") &&
    ...
    var Xo,
        ...
        er = (function () {
            ...
            return (
                ...
                (n._getConfig = function (t) {
                    return (t = o(o(o({}, tr), _t.getDataAttributes(this._element)), "object" == typeof t && t ? t : {})), _(Fo, t, this.constructor.DefaultType), t;
                }),
                (n._setListeners = function () {
                    var t = this;
    ...
    return (
        Array.from ||
            (Array.from =
                ...
                function (t) {
                    ...
                    for (var r, s = qo(n.length), a = Bo(e) ? Object(new e(s)) : new Array(s), l = 0; l < s; ) (r = n[l]), (a[l] = o ? ("undefined" == typeof i ? o(r, l) : o.call(i, r, l)) : r), (l += 1);
                    return (a.length = s), a;
                })),
        ...
        "object" == typeof exports && "undefined" != typeof module ? Qo() : "function" == typeof define && define.amd ? define(Qo) : Qo(),
        (function () {
            function t(t, e) {
        ...
        { AsyncLoad: Z, Alert: it, Button: dt, Carousel: xt, ClassToggler: Yt, Collapse: Zt, Dropdown: kn, Modal: Vn, Popover: Oi, Scrollspy: Hi, Sidebar: Ao, Tab: Ho, Toast: er, Tooltip: mi }
    );
});
